...
def Registration(request):
    if request.method =='POST':
            ...
            data=Registrationform.objects.cre(NAME=Name,PASSWORD=make_password(Password),EMAIL=Email,PHONE_NUMBER=Phone_number,CATEGORY=Category,AGE=Age,GENDER=Gender)
