...
def Registration(request):
    if request.method == 'POST':
            ...
            data=Registrationform.ojects.create(NAME=Name,PASSWORD=make_password(Password),EMAIL=Email,PHONE_NUMBER=Phone_number,CATEGORY=CategoryAGE=Age,GENDER=Gender)
