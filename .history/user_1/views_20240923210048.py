...
def delete_data(request):
    if request.method == "POST":
        ...
        try:
            ...
            user_category = registration.Category

            # Delete from corresponding table based on user category
            if user_category == "Doctors":
                Doctors.objects.get(USER_NAME=User_name).delete()
                message = 'Deleted successfully data of doctors'
            elif user_category == 'Staffs':
            ...
            # Finally, delete the Registrationform entry
            registration.delete()
